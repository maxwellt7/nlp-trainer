...
db.exec(`
  ...
  -- Identity & Value Alignment System
  CREATE TABLE IF NOT EXISTS value_hierarchy (
    ...
    behavioral_commitment TEXT DEFAULT '',
  ...
  CREATE TABLE IF NOT EXISTS value_evidence (
    id            TEXT PRIMARY KEY,
    user_id       TEXT NOT NULL REFERENCES users(id),
    value_id      TEXT REFERENCES value_hierarchy(id),
    session_id    TEXT REFERENCES sessions(id),
  ...
  CREATE TABLE IF NOT EXISTS value_conflicts (
    id            TEXT PRIMARY KEY,
    user_id       TEXT NOT NULL REFERENCES users(id),
    value_a_id    TEXT REFERENCES value_hierarchy(id),
    value_b_id    TEXT REFERENCES value_hierarchy(id),
  ...
  CREATE TABLE IF NOT EXISTS identity_scores (
    ...
    user_id       TEXT NOT NULL REFERENCES users(id),
    date_key      TEXT DEFAULT (date('now')),
    value_clarity       REAL DEFAULT 0.0,
    value_alignment     REAL DEFAULT 0.0,
    hierarchy_stability REAL DEFAULT 0.0,
    purity_ratio        REAL DEFAULT 0.0,
    conflict_awareness  REAL DEFAULT 0.0,
    worthiness_independence REAL DEFAULT 0.0,
    decision_speed      REAL DEFAULT 0.0,
    congruence_score    REAL DEFAULT 0.0,
    overall_identity_score REAL DEFAULT 0.0,
    created_at    TEXT DEFAULT (datetime('now'))
  );
